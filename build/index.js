...
const searching = new _modules_Search__WEBPACK_IMPORTED_MODULE_4__["default"]();
...
"use strict";
__webpack_require__.r(__webpack_exports__);
// Code copied from ACF Google Map https:www.advancedcustomfields.com/resources/google-map/
...
class Search {
  ...
  async getResults() {
    try {
      ...
      const response = await axios__WEBPACK_IMPORTED_MODULE_0___default().get(pcconceptsData.root_url + "/wp-json/pc-concepts/v1/search?term=" + this.searchField.value);
      ...
      results.contact.length ? '<ul class="link-list min-list">' : `<p>No locations match that search. <a href="${pcconceptsData.root_url}/contact-us">View all locations</a></p>`}
            ...
            ${results.workshop.length ? "" : `<p>No workshops match that search. <a href="${pcconceptsData.root_url}/workshops">View all workshops</a></p>`}
              ${results.workshop.map(item => `
              ...
              `).join("")}
                ...
                ${results.service.length ? "" : `<p>No Services match that search. <a href="${pcconceptsData.root_url}/services">View all Services</a></p>`}
                  ${results.service.map(item => `
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkpc_concepts_theme"] = self["webpackChunkpc_concepts_theme"] || [];
